...
namespace VRStandardAssets.Utils
{
    ...
    public class VREyeRaycaster : MonoBehaviour
    {
        ...
        public VRInteractiveItem CurrentInteractible { get; private set; }
        ...
        private void EyeRaycast()
        {
            ...
            {
                VRInteractiveItem interactible = hit.collider.transform.parent.GetComponent<VRInteractiveItem>(); //attempt to get the VRInteractiveItem on the hit object
