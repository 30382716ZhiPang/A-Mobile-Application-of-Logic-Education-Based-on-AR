...
public class LootAtPos : MonoBehaviour
{
    public static LootAtPos _instance;
    ...
    private int id;
    private int Item;
    private string LootAtPosSpeedStr;
    ...
    private void AwakeData(){
        ...
        LootAtPosSpeedStr=ModelItem.ToString()+id.ToString()+Item.ToString()+BehaviourKeyWord.LootAtSpeed.ToString();
    }
    ...
    public void Show(){
        ...
        if(PlayerPrefs.HasKey(LootAtPosSpeedStr)){
            Speed=(int)PlayerPrefs.GetFloat(LootAtPosSpeedStr);
            switch(Speed){
